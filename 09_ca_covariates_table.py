...
# =======================================================================
# PART 1 — STEP 4 : COVARIATES ANALYSIS (California)
# =======================================================================

# Configuration
DATA_DIR = "Donnees_Merged/MCTNet_california"
OUTPUT_FILE = "CA_covariables_ranges.png"
...
def main():
    print(f"-> Starting analysis for California covariates...")
    
    pattern = os.path.join(DATA_DIR, "california_merged_t*.csv")
    ...
    for i, f in enumerate(files):
        ...
        # Ensure we use pixel_id as index for correct alignment
    ...
    fig.text(0.5, 0.92, 'California Crop Covariate Analysis', 
    ...
    table.scale(1, 3.2) # Increased vertical scale for better padding
    ...
    # Add a source footer
    fig.text(0.05, 0.05, 'Source: MSF-MCTNet California Dataset (Donnees_Merged)', 
    ...
    # Optional: show if running in interactive env
    # plt.show()
